          ...
          <>
            ...
            <form onSubmit={handleEmailSubmit} className="mt-5">
              <Input
                ...
                autoComplete="email"
                disabled={isLoading}
                className="h-16 rounded-full border-white/15 bg-white/5 px-6 text-lg text-white shadow-none placeholder:text-white/30 focus-visible:border-white/40 dark:border-white/15 dark:bg-white/5"
              />
              {error && (
